...
public class HtmlBuilder {
    ...
    private static final String CSS = "<style>\n" +
            ...
            ".sidebar { width: 30vw;height: 100vh;background-color:#0288D1;float:left; overflow:auto;}\n" +
            ".mainDisplay { width: 70vw;height: 100vh;float:left;background-color:#E1F5FE;display:table; }\n" +
            ".table_div { margin:0;overflow: auto;margin: 0 10px; }\n" +
            ...
            ".content {width:60vw;height:80vh;margin-left:5vw;background:#fff;border:1px solid #f5ab36;z-index:1;text-align:center;padding:10px 0;overflow: auto;}\n" +
            "</style>\n";
    ...
    public void showTableContent(DynamicRealm dynamicRealm, HashMap<String, String> queryMap) {
        try {
            ...
            stringBuilder.append("<div class=\"table_content\" style=\"margin:0;overflow:auto;margin: 0 10px;\">");
