...
public class ListActivity extends AppCompatActivity {
    ...
    private void permissionChecking(){
        ...
        if (CURRENT_ANDROID_VERSION >= Build.VERSION_CODES.M) { //Marshmallow
            ...
            if (ContextCompat.checkSelfPermission(ListActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION)
        ...
        switch (requestCode) {
            case PERMISSIONS_REQUEST_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(ListActivity.this,"Permission is Denied!",Toast.LENGTH_LONG).show();
                }
                return;
            }
