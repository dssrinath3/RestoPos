...
import hiaccounts.in.restopos.utility.Flags;
import hiaccounts.in.restopos.utility.UIUtil;
import hiaccounts.in.restopos.utility.ValidationUtil;
...
abstract public class AwesomeSplash extends AppCompatActivity {
    ...
    public void initUI(int flag) {
        ...
        switch (flag) {
            ...
            case Flags.WITH_LOGO:
                ...
                mImgLogo.setImageResource(R.drawable.restologo);
                break;
            default:
                break;
    ...
    public void startCircularReveal() {
        ...
        SupportAnimator animator = io.codetail.animation.ViewAnimationUtils.createCircularReveal(mRlReveal, x, y, 0, finalRadius);
